# Disables the listed plans in SKU STANDARDPACK 
...
$LO = New-MsolLicenseOptions -AccountSkuId "pathfinderservices:STANDARDPACK" -DisabledPlans POWER_VIRTUAL_AGENTS_O365_P1,KAIZALA_O365_P2,Deskless,FLOW_O365_P1,POWERAPPS_O365_P1,SWAY,YAMMER_ENTERPRISE,MCOSTANDARD
